...
import pae.a.project.ktp.exceptions.NonexistentEntityException;
import pae.a.project.ktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pae.a_project.ktp_jar_0.0.1-SNAPSHOTPU");
